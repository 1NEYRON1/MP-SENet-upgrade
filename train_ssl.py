"""
Training script with SSL (Self-Supervised Learning) loss.
Uses NVIDIA NeMo SSL model to compute embedding similarity loss between clean and enhanced audio.
"""
import warnings
...
def main():
    print('Initializing Training Process with SSL Loss..')
    ...
    parser.add_argument('--checkpoint_path', default='cp_model_ssl')
