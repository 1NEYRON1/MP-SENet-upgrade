"""
Training script with Multi-Scale Discriminator.
Uses multiple STFT resolutions for more robust perceptual quality assessment.
"""
import warnings
            ...
            if rank == 0:
                ...
                if steps % a.stdout_interval == 0:
                    ...
                    print('Steps : {:d}, Gen Loss: {:4.3f}, Disc Loss: {:4.3f}, Metric loss: {:4.3f}, '
                          ...
                          'STFT Loss: {:4.3f}, s/b: {:4.3f}'.
                           format(steps, loss_gen_all, loss_disc_all, metric_error, mag_error, pha_error, 
                                  com_error, time_error, stft_error, time.time() - start_b))
...
def main():
    print('Initializing Training Process with Multi-Scale Discriminator..')
    ...
    parser.add_argument('--checkpoint_path', default='cp_model_multi')
